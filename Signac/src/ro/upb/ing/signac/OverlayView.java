...
public class OverlayView extends View {
	...
	private void init(Context context){
        ...
        mPaintingImage = BitmapFactory.decodeResource(context.getResources(), R.drawable.signac);
	...
	protected void onSizeChanged(int xNew, int yNew, int xOld, int yOld) {
		...
		//Log.e("DE LA MINE >>>>", "intra in OnSizeChanged");
		...
		polyPath[0].lineTo(0, (int) (mHeight * 0.30));
		polyPath[0].lineTo((int)(mWidth*0.70), (int) (mHeight * 0.30));
		polyPath[0].lineTo((int) (mWidth * 0.78), 0);
		polyPath[0].close();
		...
		//Zone 2 - Boats
	    // path
	    polyPath[1].moveTo(mWidth, 0);
	    polyPath[1].lineTo(mWidth, (int)(mHeight*0.30));
	    polyPath[1].lineTo((int)(mWidth*0.78), (int)(mHeight*0.30));
	    polyPath[1].lineTo((int)(mWidth*0.78), (int)(mHeight*0.64));
		polyPath[1].lineTo(0, (int) (mHeight * 0.30));
		polyPath[1].lineTo((int)(mWidth*0.70), (int) (mHeight * 0.30));
		polyPath[1].lineTo((int) (mWidth * 0.78), 0);
	    polyPath[1].close();
	    ...
	    polyPath[2].lineTo(mWidth, mHeight);
	    polyPath[2].lineTo(mWidth, (int)(mHeight*0.30));
	    polyPath[2].lineTo((int)(mWidth*0.78), (int)(mHeight*0.30));
	    polyPath[2].lineTo((int)(mWidth*0.78), (int)(mHeight*0.64));
		polyPath[2].lineTo(0, (int) (mHeight * 0.30));
	    polyPath[2].close();	
	...
	protected void onDraw(Canvas canvas) {
		...
		switch(SCREEN_NUMBER){
			...
			case 7:
				...
				//draw zones
				mPaint.setColor(Color.argb(90, 32, 32, 32));
	...
	public void playZone(int zone){
		...
		if (SCREEN_NUMBER == 8){
			...
			if (_playZone == -1 && zone > -1){
				switch(zone){
				case 0:
					mMusicFader.load("background", true);
					mMusicFader.play(1000);
					break;
				case 1:
					mMusicFader.load("boats", true);
					mMusicFader.play(1000);
					break;
				case 2:
					mMusicFader.load("woman", true);
					mMusicFader.play(1000);
					break;
				}
				_playZone = zone;
